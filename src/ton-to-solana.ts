...
async function main() {
  ...
  try {
    ...
    logger.info(`Route: TON (${sourceChain}) -> Solana (${targetChain})`);
    ...
    logger.step(4, 'Polling Multi-Hop Status (TON -> Solana)...');
